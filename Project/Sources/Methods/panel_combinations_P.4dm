...
$vT_form:="panel_combinations"
$vJ_pref_file:=zen__prefs_get_c4Fo.file($vT_form+".json")  // Common file
$isOk:=wox_prefs_load($vJ_pref_file; ->$vJ_prefs; 0)  // Version, increase to reset
//If (Not($isOk))
...
$isOk:=zenh_form_open(Null:C1517; $vT_form; "Panel Combinations"; $vJ_form)
