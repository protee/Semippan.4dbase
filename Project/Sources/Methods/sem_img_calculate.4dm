...
var $is_SETS_shape; $is_MEDIA; $is_set_shape : Boolean
var $vL_text_color; $vL_index; $vL_space; $vL_shape; $vL_img_offset_x; $vL_img_offset_y; $vL_text_style; $vL_SETS_width; $vL_SETS_heigth; $vL_SETS_stroke; $vL_media_tl; $vL_media_tr; $vL_media_br; $vL_media_bl : Integer
...
var $vR_text_coef; $vR_img_coef; $vR_SETS_size; $vR_img_brightness; $vR_radius_tl; $vR_radius_tr; $vR_radius_coef; $vR_radius_br; $vR_radius_bl; $vR_SETS_offset_x; $vR_SETS_offset_y : Real
var $vT_text_font; $vT_MEDIA_text; $vT_dom_picture; $vT_stroke_color; $vT_fill_color : Text

$vJ_options:=$cE_SETS.j_options
$vJ_metarect:=$cE_SETS.j_metarect
$vJ_picture:=$cE_SETS.j_picture
$vJ_text:=$cE_SETS.j_text
$is_set_shape:=$cE_SETS.j_options.isSetShape
...
$vL_shape:=$vJ_options.isSetShape || ($vL_MEDIA_shape=0) ? $cE_SETS.shape : $vL_MEDIA_shape
$vL_img_offset_x:=Choose:C955($is_img_offset; 1; 0)
...
$vL_SETS_width:=$cE_SETS.width
$vL_SETS_heigth:=$cE_SETS.height
$vR_SETS_size:=$cE_SETS.size/100
$vL_angle:=$vJ_picture.l_angle+$vL_MEDIA_angle
$vR_img_brightness:=1+(($vL_brightness+$vL_MEDIA_brightness)/100)

$vL_SETS_stroke:=$cE_SETS.stroke
$is_SETS_shape:=$vJ_options.isSetShape
$vR_radius_coef:=Square root:C539(($vL_SETS_width*$vL_SETS_width)+($vL_SETS_heigth*$vL_SETS_heigth))*$vR_SETS_size/50

$vR_radius_tl:=$is_SETS_shape || ($vL_media_tl<0) ? $vJ_metarect.l_tl : $vL_media_tl
$vR_radius_tr:=$is_SETS_shape || ($vL_media_tr<0) ? $vJ_metarect.l_tr : $vL_media_tr
$vR_radius_tl*=$vR_radius_coef
$vR_radius_tr*=$vR_radius_coef

If ($vL_shape=15)  // Metarect !
	$vR_radius_br:=$is_SETS_shape || ($vL_media_br<0) ? $vJ_metarect.l_br : $vL_media_br
	$vR_radius_bl:=$is_SETS_shape || ($vL_media_bl<0) ? $vJ_metarect.l_bl : $vL_media_bl
	$vR_radius_br*=$vR_radius_coef
	$vR_radius_bl*=$vR_radius_coef
End if 

$vR_SETS_offset_x:=$vJ_text.l_offsetX/100  // [0-1]
$vR_SETS_offset_y:=$vJ_text.l_offsetY/100
...
$vL_SETS_width; $vL_SETS_heigth; $vR_SETS_size; $vR_radius_tl; $vR_radius_tr; \
$vR_radius_br; $vR_radius_bl; $vL_SETS_stroke; $vL_shape; $vL_colors; \
$vT_MEDIA_text; $vL_angle; $vT_text_font; $vR_text_coef; $vL_text_color; \
$vL_text_style; $vR_SETS_offset_x; $vR_SETS_offset_y; $vO_img_picture; $vR_img_coef; \
